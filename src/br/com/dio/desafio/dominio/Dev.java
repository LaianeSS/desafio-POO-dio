...
public class Dev {
    ...
    public void progredir() {
        ...
        if(conteudo.isPresent()){
            ...
            System.out.println("Você não está inscrito em nenhum conteúdo de bootcamp!");
        }
    }
    ...
    public Set<Conteudo> getConteudosCncluidos() {
        return conteudosConcluidos;
    }

    public void setConteudosCncluidos(Set<Conteudo> conteudosCncluidos) {
        this.conteudosConcluidos = conteudosCncluidos;
    }
